...
def iterative_deepening_search(root, goal):
    max_depth = 20  # Максимальная глубина для поиска
...
# Построение дерева
root = BinaryTreeNode(11)
left_child = BinaryTreeNode(12)
right_child = BinaryTreeNode(3)
root.add_children(left_child, right_child)
right_child.add_children(BinaryTreeNode(14), BinaryTreeNode(15))
# Целевое значение
goal = 4
