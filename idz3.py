...
root = TreeNode("dir1", "rwxr-xr-w")
root.add_child(TreeNode("file1", "rwxr-xr--"))
root.add_child(TreeNode("dir2", "rwxr--r-w"))
root.children[0].add_child(TreeNode("file2", "rwxr-xr--"))
root.children[0].add_child(TreeNode("file3", "rw-r-xr--"))
root.children[1].add_child(TreeNode("file4", "rwxr-xr--"))
root.children[1].add_child(TreeNode("dir3", "rwxr--r--"))
root.children[1].children[1].add_child(TreeNode("file5", "rw-r--r-w"))
root.children[1].children[1].add_child(TreeNode("file6", "rwxr-xr--"))
root.children[1].children[1].add_child(TreeNode("file7", "rwxr-xrw-"))

# Цель поиска
goal_permissions = "rwxr--r--"
